...
///
class BlaColors {
  static Color primary = const Color.fromARGB(255, 28, 120, 201);
  static Color secondary = Color.fromARGB(255, 7, 29, 37);
  ...
  static Color neutralLighter = const Color.fromARGB(255, 219, 220, 220);
...
class BlaTextStyles {
  ...
  static TextStyle price = TextStyle(fontSize: 20, fontWeight: FontWeight.w800,color: BlaColors.secondary);
  static TextStyle loc = TextStyle(
    fontSize: 16,
